...
var createQuiz = React.createClass({
              ...
              return React.DOM.div(
                 ...
                 return  React.DOM.div(null,
                          React.DOM.div(
                            ...
                            React.DOM.h3({className:"text-center"},"Question: "+ (this.state.position+1) +" OF " +this.props.data.length )
                          ),
                         React.DOM.h3({style:{marginLeft:"5em"}},
                             "Question."+(this.state.position+1)+":"+this.state.question),
                         React.DOM.div({
                             style:{fontSize:"17px", marginLeft:"7em"}},
                             React.DOM.br(null),
                             React.DOM.input(
                                 {
                                    type: "radio",
     ...
     _footer: function(){
    return React.DOM.div({className:"panel-footer navbar-fixed-bottom text-center" }, "Copyrights: Aashir Haque");
},
     render: function(){
         return React.DOM.div(
             null,
             React.DOM.div( 
                    {
                    className:"panel-heading bg-success",
                    id: 'header',
                    },
                    React.DOM.h1({style:{fontSize:"60px"}, className:"text-center"},"Quiz App React")
             ),
             React.DOM.div(
                 null,
